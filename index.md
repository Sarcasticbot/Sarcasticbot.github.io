...
<head>
    <style>
        ...
        .background {
            ...
            animation: moveBackground 30s linear infinite, floatBackground 6s ease-in-out infinite;
        }
...
<body>
    ...
    <div class="content">
        <h1>Floating and Moving Background</h1>
        <p>This is some content on top of the floating and moving background.</p>
    </div>
</body>
</html>
<!DOCTYPE html>
